...
public abstract class DynamicEntity implements Entity {
    ...
    /**
     * get the kinematicState of entity
     * @return the instance of KinematicState
     */
    public abstract KinematicState getKinematicState();

    /**
     * Make ballboy be orbited by this entity
     * @param BallBoy the ballboy
     */
    public abstract void orbited(DynamicEntity BallBoy);
