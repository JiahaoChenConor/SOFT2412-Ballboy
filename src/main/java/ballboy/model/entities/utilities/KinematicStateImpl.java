...
public class KinematicStateImpl implements KinematicState {
    ...
    public KinematicStateImpl(KinematicStateImpl other){
        this.position = new Vector2D(other.position.getX(), other.position.getY());
        this.previousPosition = new Vector2D(other.previousPosition.getX(), other.previousPosition.getY());
        this.velocity = new Vector2D(other.velocity.getX(), other.velocity.getY());
        this.horizontalAcceleration = other.horizontalAcceleration;
    }

    @Override
    public KinematicState cloneKine(){
        return new KinematicStateImpl(this);
    }
